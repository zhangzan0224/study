...
export default {
  ...
  computed: {
    ...
    imagePosition () {
      if (!this.containerHeight || !this.containerWidth || !this.imgHeight || !this.imgWidth) {
        return
      }
...
.carousel-item-container {
  ...
  .title,.desc {
    ...
    left: 30px;
    color: #fff;
    text-shadow: 1px 0 0 rgba(0, 0, 0, 0.5), -1px 0 0 rgba(0, 0, 0, .5), 0 1px 0 rgba(0, 0, 0, .5), 0 -1px 0 rgba(0, 0, 0, .5);
    white-space: nowrap;
    overflow: hidden;
    opacity: 0;
    // 通过修改width来进行动画
